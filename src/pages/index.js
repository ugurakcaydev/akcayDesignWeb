...
const products = [
  ...
  },
  {
    ...
    images: "/Images/bedroom4.jpg", //'/Images/bedroom2.jpg'
  },
  {
  ...
  },
  {
    ...
    images: "/Images/livingroom1.jpg", //'/Images/drawr1.jpg',
  },
  {
    name: "Banyo Tasarımlarımız",
    images: "/Images/bathroom3.jpg",
  },
  {
    name: "Banyo Tasarımlarımız",
    images: "",
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        ...
        <div className="content">
          <div className="productAndHeaderContainer">
            <p className="header">ÖNE ÇIKAN ÜRÜNLERİMİZ</p>
                ...
                <div className="outsideProduct" key={index}>
                  <div className="productImage">
                    {product.images.length > 0 ? (
                      <Link
                        href={{
                          pathname: `/product-details/${product.name
                            .toLowerCase()
                            .replace(/\s+/g, "-")}`,
                        }}
                      >
          ...
          <div className="servicesAndHeaderContainer">
            <p className="header">HİZMETLERİMİZ</p>
